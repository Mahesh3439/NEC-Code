...
import { IProjectSpaceProps,IProjectSpaceState } from './IProjectSpaceProps';
...
import { Label, TextField, PrimaryButton, DefaultButton, DatePicker, Dialog, DialogType, DialogFooter } from 'office-ui-fabric-react/lib';
...
export default class ProjectSpace extends React.Component<IProjectSpaceProps,IProjectSpaceState, {}> {
  ...
  constructor(props: IProjectSpaceProps) {
      super(props);
  ...
  public render(): React.ReactElement<IProjectSpaceProps> {
      return (
          <div className="">
                          ...
                          <div className="row">
                              <div className="profile-user-info profile-user-info-striped">
                                  ...
                                  <div className="profile-info-row">
                                      ...
                                      <div className="profile-info-value">
                                          <TextField id="ReqAction" underlined onBlur={this.handleChange.bind(this)} />
                                      </div>
                                  </div>
